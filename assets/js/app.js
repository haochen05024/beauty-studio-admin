...
const seed={
  ...
  booking:{openingTime:'10:00',closingTime:'18:00',slotMinutes:30,advanceDays:30,minLeadMinutes:60,status:'open',bookingMessage:'Appointments are confirmed after your request is reviewed.',bookingMessageZh:'',bookingMessageMy:''},
  media:{}
};
...
async function loadRemote(){
  ...
  try{
    ...
    if(!String(data.booking.bookingMessage||'').trim() && String(data.content.bookingMessage||'').trim()) data.booking.bookingMessage=data.content.bookingMessage;
    if(!String(data.booking.bookingMessageZh||'').trim() && String(data.content.bookingMessageZh||'').trim()) data.booking.bookingMessageZh=data.content.bookingMessageZh;
    if(!String(data.booking.bookingMessageMy||'').trim() && String(data.content.bookingMessageMy||'').trim()) data.booking.bookingMessageMy=data.content.bookingMessageMy;
...
/* v88 — Booking copy moved into Booking Rules + expanded Admin i18n for Contact Links */
...
const ADMIN_I18N={
  en:{
    ...
    'Customer contact actions':'Customer contact actions',
    'Connect every action shown in the customer Contact section. Leave a link empty to use the safe default.':'Connect every action shown in the customer Contact section. Leave a link empty to use the safe default.',
    'Map link':'Map link',
    'Availability link':'Availability link',
    'Call link':'Call link',
    'TikTok link':'TikTok link',
    'WhatsApp link':'WhatsApp link',
    'Telegram link':'Telegram link',
    'This message is stored with Booking Rules and follows the customer\'s language selector.':'This message is stored with Booking Rules and follows the customer\'s language selector.'
  },
  zh:{
    ...
    'CONTACT LINKS':'联系链接',
    'Customer contact actions':'客户联系入口',
    'Connect every action shown in the customer Contact section. Leave a link empty to use the safe default.':'连接客户 Contact 区域中的所有入口。留空则使用安全默认设置。',
    'Map link':'地图链接',
    'Availability link':'预约入口链接',
    'Call link':'电话链接',
    'TikTok link':'TikTok 链接',
    'WhatsApp link':'WhatsApp 链接',
    'Telegram link':'Telegram 链接',
    'This message is stored with Booking Rules and follows the customer\'s language selector.':'这段提示保存在预约规则中，并会跟随客户网站的语言切换。'
  },
  my:{
    ...
    'CONTACT LINKS':'ဆက်သွယ်ရန်လင့်ခ်များ',
    'Customer contact actions':'ဖောက်သည်ဆက်သွယ်ရန်လုပ်ဆောင်ချက်များ',
    'Connect every action shown in the customer Contact section. Leave a link empty to use the safe default.':'ဖောက်သည် Contact အပိုင်းရှိ လုပ်ဆောင်ချက်အားလုံးကို ချိတ်ဆက်ပါ။ ဗလာထားပါက လုံခြုံသော မူရင်းကို အသုံးပြုပါမည်။',
    'Map link':'မြေပုံလင့်ခ်',
    'Availability link':'ရရှိနိုင်မှုလင့်ခ်',
    'Call link':'ဖုန်းလင့်ခ်',
    'TikTok link':'TikTok လင့်ခ်',
    'WhatsApp link':'WhatsApp လင့်ခ်',
    'Telegram link':'Telegram လင့်ခ်',
    'This message is stored with Booking Rules and follows the customer\'s language selector.':'ဤမက်ဆေ့ချ်ကို ဘွတ်ကင်စည်းမျဉ်းများနှင့်အတူ သိမ်းဆည်းပြီး ဖောက်သည်ဝဘ်ဆိုဒ် ဘာသာစကားရွေးချယ်မှုနှင့်အတူ ပြောင်းလဲပါမည်။'
  }
};
